...
def title():
    clear()
    banner = (Colorate.Vertical(Colors.purple_to_red, art.text2art("ProtnGen", font="tarty1")))
    ctypes.windll.kernel32.SetConsoleTitleW("ProtonGen | By: Takkeshi | Version: 2.0.0")
    print(banner)
    print(f"{separator}\n")
...
if option == 2: 
    print(f"{Colors.pink}Thanks for using ProtonGen V2!{Colors.white}")
    time.sleep(2)
    exit()